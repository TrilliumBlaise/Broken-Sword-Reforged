...
function checkPrimeWeapon() {
    ...
    const element1 = primeWeapon.weaponElement1.element;
    const element2 = primeWeapon.weaponElement2.element;
    const element3 = primeWeapon.weaponElement3.element;
    const element4 = primeWeapon.weaponElement4.element;

    if (element1 === 'None' || element2 === 'None' || element3 === 'None' || element4 === 'None') {
        return false;
    }
    return true;
}
